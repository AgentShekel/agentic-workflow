...
python .claude/skills/design-system-methodology/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python .claude/skills/design-system-methodology/scripts/search-slides.py "series a funding" -d strategy --json
```
