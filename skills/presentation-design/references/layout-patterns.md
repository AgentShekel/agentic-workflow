...
|-----------|-------------|
| `gradient-glow` | Title presentation-design, CTAs |
...
python .claude/skills/design-system-methodology/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .claude/skills/design-system-methodology/scripts/search-slides.py "traction slide" \
