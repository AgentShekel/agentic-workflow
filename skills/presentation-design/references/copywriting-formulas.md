...
**Use:** Problem presentation-design, pain points
...
python .claude/skills/design-system-methodology/scripts/search-slides.py "problem agitation" -d copy

# Get emotion-appropriate formula
python .claude/skills/design-system-methodology/scripts/search-slides.py "urgency cta" -d copy
```
