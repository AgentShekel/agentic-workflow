...
domain: dev
description: |
  [METHODOLOGY] Pre-deploy acceptance testing (run test suite —
  unit/integration/E2E, verify acceptance criteria from user-spec and tech-spec,
  no live environment needed). Preloaded by pre-deploy-qa agent.
---
