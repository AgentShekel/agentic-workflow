...
domain: meta
description: |
  [METHODOLOGY] Design test scenarios for skills through user
  interview. Reads the target skill, interviews about scope and edge cases,
  saves scenario files for skill-testing to execute. Pure reference — invoked
  via slash command or explicit Skill tool call, not auto-triggered.
---

# Skill Test Designer

Design test scenarios for skills. Interview the user to understand what to
test, then create detailed scenario files for skill-testing to execute.
...
5. Confirm to user: "Scenarios saved at [path]. Run skill-testing to execute."
