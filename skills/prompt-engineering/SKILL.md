...
domain: meta
description: |
  [METHODOLOGY] Guide for writing effective prompts for LLMs based on
  Anthropic + OpenAI 2025-2026 guidelines. Pure reference — invoked via slash
  command or explicit Skill tool call, not auto-triggered by keywords.
---
