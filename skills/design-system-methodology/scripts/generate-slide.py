...
# -*- coding: utf-8 -*-
"""
Slide Generator - Generates HTML presentation-design using design tokens
...
OUTPUT_DIR = Path(__file__).resolve().parents[4] / "assets" / "designs" / "presentation-design"
...
def main():
    ...
    if args.demo:
        ...
        html = generate_deck(data.get('presentation-design', []), data.get('title', 'Presentation'))
