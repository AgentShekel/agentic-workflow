...
Usage:
  ...
  python html-token-validator.py --type presentation-design      # Validate only slides
...
ASSET_DIRS = {
    'presentation-design': PROJECT_ROOT / 'assets' / 'designs' / 'presentation-design',
...
Examples:
  ...
  %(prog)s --type presentation-design             # Validate only slides
...
"""
    ...
    parser.add_argument('-t', '--type', choices=['presentation-design', 'infographics', 'all'],
