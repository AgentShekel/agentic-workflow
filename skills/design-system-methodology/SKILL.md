...
domain: design
description: |
  [METHODOLOGY] Token architecture (primitive→semantic→component),
  CSS variables, spacing/typography scales, component specifications.
