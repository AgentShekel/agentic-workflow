...
domain: dev
description: |
  [METHODOLOGY] New project planning (adaptive interview, tech
  decisions, fill project-knowledge documentation in one session). Preloaded
  by dev-product-analyst agent.
---
