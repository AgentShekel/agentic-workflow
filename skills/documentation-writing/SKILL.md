...
domain: dev
description: |
  [METHODOLOGY] Project documentation maintenance in
  .claude/skills/project-knowledge/ (audit, edit, consistency, status tracking).
  Preloaded by dev-technical-writer agent.
---
