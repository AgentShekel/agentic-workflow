...
domain: dev
description: |
  [METHODOLOGY] Dev infrastructure setup (framework init, folder
  structure, Docker, pre-commit hooks with gitleaks, testing infrastructure,
  .gitignore). Preloaded by dev-devops-engineer agent.
---
